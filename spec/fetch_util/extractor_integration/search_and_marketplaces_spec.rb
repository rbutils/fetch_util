...
RSpec.describe 'FetchUtil extractor integration' do
  ...
  it "salvages amazon search pages into compact product bullets" do
    html = <<~HTML
      <html>
  ...
  it "salvages amazon product pages from description and bullets" do
    html = <<~HTML
      <html>
        <head>
  ...
  it "salvages quora security pages with a question heading and warning" do
    html = <<~HTML
      <html>
        <head>
