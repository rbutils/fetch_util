  ...
  var ACCOUNT_ACTION_TEXT_PATTERN = /^(report this article|\+?\s*follow|sign in|sign up|join now|show more|show less|log in|create account|create an account|subscribe to read|inloggen|iniciar sessão|entrar|prijavi se|пријави се|log masuk|maak een account|criar conta|registreer|cadastre-se|přihlásit se|logga in|log ind|logg inn|inicia sessió|iniciar sessió|giriş yap|შესვლა|පිවිසෙන්න|daxil ol|zaloguj się|zarejestruj się|zaloguj|załóż konto|moje konto|dołącz do nas|zobacz więcej|czytaj więcej|czytaj dalej|pokaż więcej|zwiń|rozwiń)$/;
  var AD_LABEL_TEXT_PATTERN = /^(skip ad|continue watching|visit advertiser website|go to page|advertisement \d+\/\d+|advertisement|close ad|skip this ad|skip in \d+|ad \d+ of \d+|sponsored|sponsor|reklama|materiał sponsorowany|materiał promocyjny|materiał partnerski|autopromocja|ad$)/;
