  ...
  function collectMetadata() {
    ...
    return {
      ...
      byline: metadataValue("author", "name") || metadataValue("article:author", "property") || schemaAuthor || visibleByline(),
      ...
      publishedTime: metadataValue("article:published_time", "property") || metadataValue("publish-date", "name") || schemaPublishedTime || schemaModifiedTime || visiblePublishedTime(),
  ...
  function visibleByline() {
    ...
    return normalizeText(value || "").replace(/^by\s+/i, "") || null;
  }
