  function tempoArticleContent(metadata) {
    ...
    return profileArticleContent(metadata, body, {
      ...
      byline: firstText([".author", ".article-author", "[class*='author' i]"]) || metadata.byline,
      minTextLength: 220,
  ...
  var tempoBaseHostAwareContent = hostAwareContent;
  hostAwareContent = function(metadata, pageText) {
    return tempoArticleContent(metadata) || tempoBaseHostAwareContent(metadata, pageText);
  };
