  ...
  function drupalInstitutionalContent(metadata) {
    ...
    var title = normalizeText(((document.querySelector("h1") || {}).textContent) || metadata.title || document.title);
  ...
  function institutionalPlatformContent(metadata) {
    return drupalInstitutionalContent(metadata) || institutionalTopicCardListContent(metadata);
  }
