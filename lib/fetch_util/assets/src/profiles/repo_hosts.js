  function gitLabInstancePage(metadata) {
    if (!document.querySelector(".project-home-panel, .project-information, .readme-holder, .file-holder.readme-holder, [data-testid='blob-viewer-content'] .blob-viewer[data-path][data-rich-type='markup'], [data-testid='blob-viewer-content'] .file-content.md")) return false;
  ...
  function gitLabContent(metadata) {
    var node = document.querySelector("[data-testid='blob-viewer-content'] .blob-viewer[data-path='README.md'][data-rich-type='markup'] .file-content.md, [data-testid='blob-viewer-content'] .blob-viewer[data-path='README.md'] .file-content.md, [data-testid='blob-viewer-content'] .file-content.md, .blob-viewer[data-path='README.md'][data-rich-type='markup'] .file-content.md, .blob-viewer[data-path='README.md'] .file-content.md, .readme-holder .md, .readme-holder .wiki, .readme-holder [data-testid='readme-content'], .file-holder.readme-holder .md, .file-holder.readme-holder .wiki");
    if (!node && !gitLabInstancePage(metadata)) return null;
    if (node && !gitLabInstancePage(metadata) && !hostMatches(/(^|\.)gitlab\.com$/)) return null;
