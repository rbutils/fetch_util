  function interiaArticleContent(metadata) {
    ...
    return profileArticleContent(metadata, body, {
      ...
      byline: firstText(["[data-component-0='author-group']", "[class*='author' i]"]) || metadata.byline,
      minTextLength: 250,
      cloneRoot: false,
  ...
  var interiaBaseHostAwareContent = hostAwareContent;
  hostAwareContent = function(metadata, pageText) {
    return interiaArticleContent(metadata) || interiaBaseHostAwareContent(metadata, pageText);
  };
