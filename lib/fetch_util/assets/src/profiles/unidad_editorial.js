    ...
    return profileArticleContent(metadata, root, {
      ...
      rewriteRoot: function(cleanRoot) {
        removeAll(cleanRoot, [
          ...
          ".ue-c-ad", ".ft-ad", "[class*='advert' i]", "[aria-roledescription='Publicidad']",
          ".ue-c-article__comments", "[class*='comment' i]",
          ".ue-c-article__related", ".ft-mol-related", "[class*='related' i]", "[class*='recommend' i]",
          ".newsletter", "[class*='newsletter' i]",
          ".ft-mol-multimedia", ".jwplayer", "[class*='jw-' i]", "[class*='taboola' i]", "[class*='trc_' i]",
  ...
  function unidadEditorialArticleBody() {
    var body = document.querySelector(".ue-c-article__body[data-section='articleBody']") ||
