  function leMondeArticleContent(metadata) {
    ...
    if (offered) {
      normalizePublicArticleAccessSignals(body, metadata, {
        ...
        removalSelectors: PUBLIC_ARTICLE_PAYWALL_SELECTORS.concat(["#js-modal-gifted-url", ".article__gift-modal", ".paywall", ".js-paywall"]),
    ...
    return profileArticleContent(metadata, root, {
      ...
      rewriteRoot: function(cleanRoot) {
        removeAll(cleanRoot, PUBLIC_ARTICLE_PAYWALL_SELECTORS.concat([
          "#js-modal-gifted-url",
          ".article__gift-modal",
          ".paywall",
          ".js-paywall",
