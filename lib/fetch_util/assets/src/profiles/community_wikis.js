  ...
  function mastodonPostEntries() {
    var nodes = Array.prototype.slice.call(document.querySelectorAll(".status, article.status-public"));
    Array.prototype.slice.call(document.querySelectorAll(".status__content")).forEach(function(contentNode) {
      var article = contentNode.closest("article");
    ...
    nodes.forEach(function(node) {
      ...
      var contentNode = node.querySelector(".status__content") || node;
  ...
  function mastodonContent(metadata) {
    ...
    var displayName = firstText([".display-name strong", ".display-name b", ".display-name"]) || "";
    ...
    var bio = firstText([".account__header__content", ".account__header__bio", ".public-account-bio", ".profile__bio", "[data-testid='profile-note']"]);
