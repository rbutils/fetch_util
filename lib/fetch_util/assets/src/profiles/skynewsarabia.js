  ...
  function skyNewsArabiaArticleBody() {
    return composeProfileArticleRoot({
      scopeSelectors: [".article_detail_page", ".sna_content_body"],
      titleSelectors: [".sna_content_heading", "h1.article-title", ".slide-title", "main h1", "h1"],
      leadSelectors: [".article-sub-heading"],
      captionSelectors: [".article_image_heading_bg, .article-image-caption, .media-caption"],
      summarySelectors: [".article-summary"],
      bodySelectors: [".article-content .article-body", ".article-body", "[itemprop='articleBody']"],
      minTextLength: 250
    });
  }
