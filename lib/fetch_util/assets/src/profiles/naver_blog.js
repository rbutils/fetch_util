  ...
  if (typeof hostAwareContent === "function") {
    var naverBlogPreviousHostAwareContent = hostAwareContent;
    hostAwareContent = function(metadata, pageText) {
      return naverBlogContent(metadata) || naverBlogPreviousHostAwareContent(metadata, pageText);
    };
  }
