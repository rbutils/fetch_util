  ...
  function glossaryStructuredContent(metadata) {
    ...
    var definitions = leadDefinitions.concat(pairedDefinitions).concat(manyTexts(["p.desc", ".dtText", ".sense .dtText", ".sense", ".def", ".definition", "[class*='definition']", "li[class*='meaning'] > span", "li[class*='definition'] > span", "li[class*='sense'] > span", "[class*='meaning']", "dd", "[itemprop='description']"], 10).map(compactDefinition)).filter(function(text) {
