  ...
  function mkdocsMaterialContent(metadata, info) {
    ...
    return docsContentBySelectors(metadata, [
      ...
      rewriteRoot: function(root) {
        ...
        removeAll(root, COMMON_DOCS_CHROME_SELECTOR + ", .md-source-file, .md-content__button, .md-feedback, .mdx-badge, .md-nav, .md-sidebar");
  ...
  function mdBookContent(metadata, info) {
    return docsEngineContent(metadata, info, {
      ...
      removeSelectors: COMMON_DOCS_CHROME_SELECTOR + ", #sidebar, #sidebar-toggle, nav.sidebar, #menu-bar, #menu-bar-hover-placeholder, .nav-wrapper, .nav-chapters, .chapter, #sidebar-resize-handle, .mobile-nav-chapters",
  ...
  function docusaurusDocsContent(metadata, info) {
    return docsEngineContent(metadata, info, {
      ...
      titleSelectors: ["main .markdown h1", "main h1", "article h1", ".theme-doc-markdown h1"],
  ...
  function mintlifyDocsContent(metadata, info) {
    ...
    return docsContentBySelectors(metadata, [
      ...
      rewriteRoot: function(root) {
        ...
        removeAll(root, COMMON_DOCS_CHROME_SELECTOR + ", .menu, .table-of-contents, [data-testid='table-of-contents'], [aria-label='Table of contents'], [class*='sidebar'], [class*='toc'], #page-context-menu, #page-context-menu-button, #pagination");
  ...
  function gitbookDocsContent(metadata, info) {
    ...
    return docsArticleContent(metadata, node, {
      ...
      focusFragment: false,
      rewriteRoot: function(root) {
        removeAll(root, COMMON_DOCS_CHROME_SELECTOR + ", header, [class*='sidebar'], [class*='Sidebar'], [class*='TableOfContents'], [class*='toc'], [class*='navigation']");
  ...
  function scalarDocsContent(metadata, info) {
    ...
    return docsArticleContent(metadata, node, {
      ...
      focusFragment: false,
      rewriteRoot: function(root) {
        removeAll(root, COMMON_DOCS_CHROME_SELECTOR + ", [class*='sidebar'], [class*='Sidebar'], [class*='search'], [class*='Search']");
