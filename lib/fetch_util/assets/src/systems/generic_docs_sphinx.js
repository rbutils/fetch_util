  ...
  function sphinxDocsContent(metadata, info) {
    return docsEngineContent(metadata, info, {
      system: "sphinx",
      rootSelectors: ["div.body[role='main']", "div.body", "[role='main']", "main"],
      ...
      removeSelectors: "a.headerlink, button.copybutton, .toc-backref, .sphinxsidebar, .sphinxsidebarwrapper, aside",
