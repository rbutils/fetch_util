  function readmeIoDocsContent(metadata, info) {
    ...
    return docsArticleContent(metadata, node, {
      title: cleanDocsHeadingText(firstText(["article h1", ".rm-Article h1", "main h1", "h1"]) || docsFallbackTitleWithoutTrailingBrand(metadata)),
      focusFragment: false,
  ...
  function redocDocsContent(metadata, info) {
    ...
    var result = docsArticleContent(metadata, node, {
      title: cleanDocsHeadingText(firstText([".api-content h1", ".redoc-wrap h1", "main h1", "h1"]) || docsFallbackTitleWithoutTrailingBrand(metadata)),
      focusFragment: false,
      rewriteRoot: function(root) {
