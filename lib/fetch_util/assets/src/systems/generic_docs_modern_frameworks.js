  function vitePressDocsContent(metadata, info) {
    return docsEngineContent(metadata, info, {
      ...
      removeSelectors: "nav, aside, footer, .VPDocFooter, .VPContentDocFooter, .VPDocAsideOutline, .aside, .edit-link, .pager-link, .prev-next, .outline-link",
  ...
  function fernDocsContent(metadata, info) {
    return docsEngineContent(metadata, info, {
      ...
      removeSelectors: "nav, aside, footer, #fern-sidebar, .fern-breadcrumb, .fern-page-actions, .toc-mobile, .fern-header-tabs, .fern-api-playground, .fern-endpoint-panel",
  ...
  function rspressDocsContent(metadata, info) {
    return docsEngineContent(metadata, info, {
      ...
      removeSelectors: "nav, aside, footer, .rp-nav, .rp-sidebar, .rp-toc, .rp-doc-footer, .rp-breadcrumb, .rp-pagination",
