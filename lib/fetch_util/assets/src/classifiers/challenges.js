  ...
  function consentLikeInterstitial(interstitialType, combined, body, page) {
    ...
    var cookiePattern = new RegExp(COOKIE_CONSENT_KEYWORDS, "i");
    var cookieLeadPattern = new RegExp("^(?:" + COOKIE_CONSENT_KEYWORDS + ")");
  ...
  function consentWallPage(title, page) {
    ...
    var normalizedPage = normalizeText(page || "").toLowerCase();
    var cookiePattern = new RegExp(COOKIE_CONSENT_KEYWORDS);
    var cookieLeadPattern = new RegExp("^(?:" + COOKIE_CONSENT_KEYWORDS + ")");
