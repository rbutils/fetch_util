  ...
  function siteUnavailablePage(title, page) {
    var normalizedTitle = normalizeText(title || "").toLowerCase();
    var normalizedPage = normalizeText(page || "").toLowerCase();
    var unavailablePattern = /خطایی رخ داده|وب سایت مورد نظر در دسترس نیست|site unavailable|website unavailable|service temporarily unavailable|temporarily unavailable|service unavailable/;
