  ...
  function consentWallDominates(text) {
    ...
    var cookiePattern = /cookie settings|we use cookies|we use cookies and data|accept all cookies|reject all|reject optional cookies|more options|cookie preferences|allow the use of cookies|cookies from other companies|essential cookies|cookie notice|use cookies and similar technologies|manage cookie preferences|manage cookies|privacy choices|personalize advertising|personalized content|wish to store and access information|access information on your devices|collect personal data|personalized ads|trusted third party partners|browsing history|device identifiers|pliki cookie|ustawienia prywatności|polityka prywatności|datenschutz|données personnelles|datos personales|dati personali|utilizamos cookies|utilizziamo i cookie|preferenze cookie|accetta tutto|クッキー|Cookieプリファレンス|Cookie設定|同意設定|すべて受け入れる|すべて許可|쿠키|동의|모두 허용|全部接受|接受全部|隐私设置|файлы cookie|настройки cookie|принять все|we gebruiken cookies|nastavení souhlasu|souhlas s personalizací|soubory cookie|vi bruger cookies|vi använder cookies|kakor|samtycke|informasjonskapsler|personvern|dine data|aller media|galetes|protecció de dades|о вашој приватности|пристанак|колачић|колачиће|подешавања приватности|evästeet|evästeasetukset|käytämme evästeitä|hyväksy evästeet|tietosuoja|slapukai|slapukų nustatymai|naudojame slapukus|колачиња|приватност|поставки за колачиња|cookie-uri|confidențialitate|utilizăm cookie-uri|sīkdatnes|sīkdatņu iestatījumi|izmantojam sīkdatnes|privātums|privātuma iestatījumi|sütiket|süti beállítások|adatvédelem|adatvédelmi beállítások/i;
    if (!cookiePattern.test(normalized)) return false;

    if (/^(cookie settings|let us know your cookie preferences|allow the use of cookies|we use cookies|we use cookies and data|before you continue|manage cookie preferences|manage your privacy settings|ustawienia prywatności|pliki cookie|datenschutz|welcome we and our .+ partners? wish to store|about your privacy|cookieプリファレンスセンター|クッキー設定|同意の優先設定|쿠키 설정|개인정보 설정|cookie 偏好设置|隐私设置|настройки cookie|файлы cookie|nastavení souhlasu|souhlas s personalizací|soubory cookie|informasjonskapsler|personvern|aller media er ansvarlig for dine data|galetes|protecció de dades|о вашој приватности|пристанак|колачић|evästeasetukset|käytämme evästeitä|naudojame slapukus|slapukų nustatymai|izmantojam sīkdatnes|sīkdatņu iestatījumi|sütiket|adatvédelmi beállítások)/.test(normalized)) return true;

    var hits = normalized.match(/cookie|cookies|accept all|reject all|reject optional|more options|essential cookies|preferences|privacy choices|personal data|browsing history|device identifiers|personalized ads|personalized content|trusted third party|wish to store|manage consent|advertising cookies|strictly necessary|social media cookies|legitimate interest|pliki cookie|prywatności|datenschutz|クッキー|同意|受け入れる|쿠키|동의|허용|接受|隐私|принять|файлы cookie|souhlas|personalizac|soukromí|soubory cookie|kakor|sekretess|samtycke|privatlivs|samtykke|informasjonskapsler|personvern|dine data|galetes|protecció|пристанак|колачић|приватности|evästeet|evästeasetukset|evästeitä|käytämme evästeitä|tietosuoja|slapukai|slapukų|slapukus|naudojame slapukus|колачиња|приватност|cookie-uri|confidențialitate|sīkdatnes|sīkdatņu|sīkfailus|privātums|privātuma|sütiket|süti|adatvédelem|adatvédelmi/g) || [];
  ...
  function suspicionReasons(metadata, content, markdown, pageText, signals) {
    ...
    if (!challengeType && !interstitialType && content && content.contentType !== "search" && !docsLike) {
      if (/(ein presswire|business wire|pr newswire|prnewswire|globe newswire|globenewswire|cision|marketwired|pr\.com|accesswire|\/prnewswire\/|this press release was issued through)/i.test(body + " " + page)) {
