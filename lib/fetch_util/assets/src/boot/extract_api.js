...
=======
      if (productList && content && content.contentType !== "product" && content.contentType !== "hotel" && !content.hostAware && !content.docsLike) {
>>>>>>> hmdne
...
<<<<<<< HEAD
      if (content.contentType !== "list" && content.contentType !== "product" && content.contentType !== "recipe" && content.contentType !== "property" && content.contentType !== "hotel" && !content.hostAware && !content.docsLike && !content.legalProvision && dominantIndexListPage(content)) content = listContent(metadata);
      if (content.contentType !== "list" && content.contentType !== "product" && content.contentType !== "recipe" && content.contentType !== "property" && content.contentType !== "hotel" && !content.hostAware && !content.docsLike && !content.legalProvision && isProbablyListPage(content) && (likelyListPath() || !articleLikePath()) && !strongArticle) content = listContent(metadata);
=======
      if (content.contentType !== "list" && content.contentType !== "product" && content.contentType !== "hotel" && !content.hostAware && !content.docsLike && !content.legalProvision && dominantIndexListPage(content)) content = listContent(metadata);
      if (content.contentType !== "list" && content.contentType !== "product" && content.contentType !== "hotel" && !content.hostAware && !content.docsLike && !content.legalProvision && isProbablyListPage(content) && (likelyListPath() || !articleLikePath()) && !strongArticle) content = listContent(metadata);
>>>>>>> hmdne
