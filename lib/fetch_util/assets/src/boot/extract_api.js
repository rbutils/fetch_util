  ...
  global.FetchUtilExtract = {
    extract: function(options) {
      ...
      if (content.contentType !== "list" && !content.docsLike && dominantIndexListPage(content)) content = listContent(metadata);
      ...
      if (content.contentType === "article" && !content.docsLike && markdownIndexListPage(markdown, content)) content = relabelAsListContent(content);
