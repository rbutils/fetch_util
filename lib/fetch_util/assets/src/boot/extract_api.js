    ...
    extract: function(options) {
      ...
      if (!content) {
        ...
        if (interstitial && interstitialType !== "consent_wall") {
          ...
          var realContent = options && options.reader_mode !== false ? readabilityContent() : null;
          if (realContent) realContent = preferFallbackContent(realContent, fallbackContent());
          if (!realContent) realContent = fallbackContent();
      ...
      if (!content) {
        content = options && options.reader_mode !== false ? readabilityContent() : null;
