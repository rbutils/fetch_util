  ...
  global.FetchUtilExtract = {
    extract: function(options) {
      ...
      if (productList && content && content.contentType !== "product" && !content.hostAware && !content.docsLike) {
      ...
      if (content.contentType !== "list" && content.contentType !== "product" && content.contentType !== "recipe" && !content.hostAware && !content.docsLike && !content.legalProvision && dominantIndexListPage(content)) content = listContent(metadata);
      if (content.contentType !== "list" && content.contentType !== "product" && content.contentType !== "recipe" && !content.hostAware && !content.docsLike && !content.legalProvision && isProbablyListPage(content) && (likelyListPath() || !articleLikePath()) && !strongArticle) content = listContent(metadata);
