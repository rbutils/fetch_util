  ...
  global.FetchUtilExtract = {
    extract: function(options) {
      ...
      if (content.contentType !== "list" && content.contentType !== "product" && !content.hostAware && !content.docsLike && !content.legalProvision && dominantIndexListPage(content)) content = listContent(metadata);
      if (content.contentType !== "list" && content.contentType !== "product" && !content.hostAware && !content.docsLike && !content.legalProvision && isProbablyListPage(content) && (likelyListPath() || !articleLikePath()) && !strongArticle) content = listContent(metadata);
