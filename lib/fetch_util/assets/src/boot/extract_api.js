  ...
  global.FetchUtilExtract = {
    extract: function(options) {
      ...
      if (content.contentType !== "list" && !content.hostAware && !content.docsLike && dominantIndexListPage(content)) content = listContent(metadata);
      ...
      if (content.contentType === "article" && !content.docsLike && !strongArticle && thinSearchOrCategoryPage(content)) content = relabelAsListContent(content);
      ...
      if (content.contentType === "article" && !content.hostAware && !content.docsLike && markdownIndexListPage(markdown, content)) content = relabelAsListContent(content);
