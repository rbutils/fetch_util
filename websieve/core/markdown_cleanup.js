  var MARKDOWN_MULTILINGUAL_AD_LABEL_LINE_PATTERN = noiseMarkdownWholeLinePattern(NOISE_MARKDOWN_AD_LABEL_TERMS, "\\s*:?");
  var MARKDOWN_SOCIAL_APP_CTA_LINE_PATTERN = noiseMarkdownWholeLinePattern(NOISE_MARKDOWN_SOCIAL_APP_CTA_LINE_SOURCES);
  var MARKDOWN_MULTILINGUAL_SOCIAL_CTA_PATTERNS = noiseMarkdownPrefixLinePatterns(NOISE_MARKDOWN_SOCIAL_CTA_SOURCES);
  var MARKDOWN_POLISH_PROMO_CTA_PATTERNS = noiseMarkdownPrefixLinePatterns(NOISE_POLISH_PROMO_CTA_PREFIX_SOURCES).concat(noiseMarkdownWholeLinePatterns(NOISE_POLISH_PROMO_CTA_LINE_SOURCES));
  var MARKDOWN_ACCOUNT_LOGIN_CTA_LINE_PATTERN = noiseMarkdownWholeLinePattern(NOISE_MARKDOWN_ACCOUNT_CTA_TERMS, "\\b.*");
  var MARKDOWN_AD_NETWORK_LINK_PATTERN = new RegExp("\\[([^\\]]*)\\]\\(https?:\\/\\/(?:[a-z0-9-]+\\.)*" + NOISE_AD_NETWORK_HOST_PATTERN + "\\/[^)]*\\)", "gi");
  var MARKDOWN_AD_NETWORK_URL_LINE_PATTERN = new RegExp("^\\s*https?:\\/\\/(?:[a-z0-9-]+\\.)*" + NOISE_AD_NETWORK_HOST_PATTERN + "\\b[^\\n]*$", "gmi");
