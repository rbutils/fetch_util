  ...
  function wpHomepageContent(metadata) {
    var host = (location.hostname || "").replace(/^www\./i, "");
    if (host !== "wp.pl" || location.pathname !== "/") return null;

    var sectioned = sectionedListExtraction(document.body, wpHomepageDescriptor);
  ...
  function registerWpHomepageProfile() {
    registerHostAwareProfile(["wp.pl"], wpHomepageContent);
  }
